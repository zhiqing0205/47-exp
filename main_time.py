...
def main():
    ...
    parser.add_argument("--methods", default='stocbio', type=str,
                        help="choise method [stocbio, ttsa, saba, ma-soba, sustain, vrbo, bo-rep, accbo, meha, nova2, nova3, s-pngbio]")
    ...
    for epoch in range(args.epoch):
        ...
        print(f'[TIME] Epoch {epoch}: train={train_time:.1f}s, test={test_time:.1f}s, total={epoch_total:.1f}s, cumulative={sum(epoch_times):.1f}s ({sum(epoch_times)/3600:.2f}h)')
        global_step += 1
