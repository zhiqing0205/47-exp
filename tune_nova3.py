...
def main():
    ...
    parser.add_argument("--study_name", type=str, default="nova3_tune_v18b", help="Optuna study name")
    parser.add_argument("--db", type=str, default="sqlite:///logs/nova3_tune_v18b.db", help="Optuna storage DB")
